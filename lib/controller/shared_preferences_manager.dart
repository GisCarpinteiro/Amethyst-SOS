...
class SharedPrefsManager {
  ...
  static Future<bool> restoreAllConfigsFromFirebase(
    ...
    String groupsData =
        await GroupController.getGroupsAsString(); // ! Replace with Firebase
    String alertsData =
        await AlertController.getAlertsAsString(); // ! Replace with Firebase
    String routinesData = await RoutineController
        .getRoutinesAsString(); // ! Replace with Firebase

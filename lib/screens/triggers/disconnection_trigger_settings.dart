                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        const MSosText(
                          'Minutos de tolerancia ante desconexión:',
                          style: MSosText.normalStyle,
                        ),
                        const SizedBox(
                          height: 10,
                        ...
                        CupertinoSlidingSegmentedControl<int>(
                            ...
                            children: {
                              0: MSosText(
                                'uno',
                                style: MSosText.normalStyle,
                                textColor: toleranceTimeValue != 0 ? null : MSosColors.white,
                              ),
                              1: MSosText('dos',
                                  style: MSosText.normalStyle,
                                  textColor: toleranceTimeValue != 1 ? null : MSosColors.white),
                              2: MSosText('cinco',
                                  style: MSosText.normalStyle,
                                  textColor: toleranceTimeValue != 2 ? null : MSosColors.white),
                              3: MSosText('diez',
                                  style: MSosText.normalStyle,
                                  textColor: toleranceTimeValue != 3 ? null : MSosColors.white)
                            },
                        ...
                        const MSosButton(
                            text: "Prueba de Activador", route: '/trigger_test', style: MSosButton.subMenuLargeBtn)
                      ],
                    ),
